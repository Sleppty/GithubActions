[![Run App <Smith>, <Tyler>](https://github.com/Sleppty/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/Sleppty/GithubActions/actions/workflows/ci.yml)
